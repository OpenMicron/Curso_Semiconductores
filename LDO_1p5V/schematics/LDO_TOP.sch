...
N 80 -320 160 -320 {lab=VREF}
N 460 -230 530 -230 {lab=VOUT}
N 410 -40 410 0 {lab=VSS}
N 370 0 410 0 {lab=VSS}
...
C {/foss/designs/Curso_Semiconductores/LDO_1p5V/schematics/LDO.sym} 160 -40 0 0 {name=x1}
